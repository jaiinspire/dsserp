...
def get_extra_fields():
	vchr_account_wise_values = {}

	## Get Fields from Purchase Invoice Item
	for d in frappe.db.sql(
		""" Select
				parent as purchase_invoice,
				name,
				custom_utr as utr,
				custom_consumer_insurance__no as consumer_insurance_no,
				custom_section as section,
				custom_monthly_bimonthly as monthly_bimonthly,
				custom_due_date as due_date,
				custom_disconnection_dt as disconnection_dt,
				custom_reading__start_ as reading_start,
				custom_reading__end as reading_end,
				custom_consumption as consumption,
				custom_meeting_type as meeting_type,
				custom_participant_count as participant_count,
				custom_location as location,
				custom_remarks as remarks,
				custom_month as month,
				custom_year as year,
				custom_vehcile_no as vehicle_no,
				custom_claim_dt_from as claim_dt_from,
				custom_claim_dt_to as claim_dt_to,
				expense_account
			From
		...
		vchr_account_wise_values.setdefault(d.get("purchase_invoice"), {}).setdefault(d.get("expense_account"), d)

	## Get Fields from Expense Claim Detail
	for d in frappe.db.sql(
		""" Select
				parent as expense_claim,
				name,
				custom_utr as utr,
				custom_consumer_insurance__no as consumer_insurance_no,
				custom_section as section,
...
def get_columns(filters):
	...
	columns += [
		...
		{"label": _("Party Type"), "fieldname": "party_type", "fieldtype": "DocType", "width": 100},
	...
	columns.extend(
		[
			{"label": _("UTR"), "fieldname": "utr", "fieldtype": "Data", "width": 100},
			{"label": _("Consumer/ Insurance No."), "fieldname": "consumer_insurance_no", "fieldtype": "Data", "width": 100},
			{"label": _("Section"), "fieldname": "section", "fieldtype": "Data", "width": 100},
			{"label": _("Monthly/ Bi-Monthly"), "fieldname": "monthly_bimonthly", "fieldtype": "Data", "width": 100},
			{"label": _("Due Date"), "fieldname": "due_date", "fieldtype": "Data", "width": 100},
			{"label": _("Disconnection Dt."), "fieldname": "disconnection_dt", "fieldtype": "Data", "width": 100},
			{"label": _("Reading @ Start"), "fieldname": "reading_start", "fieldtype": "Data", "width": 100},
			{"label": _("Reading @ End"), "fieldname": "reading_end", "fieldtype": "Data", "width": 100},
			{"label": _("Consumption"), "fieldname": "consumption", "fieldtype": "Data", "width": 100},
			{"label": _("Meeting Type"), "fieldname": "meeting_type", "fieldtype": "Data", "width": 100},
			{"label": _("Participant Count"), "fieldname": "participant_count", "fieldtype": "Data", "width": 100},
			...
			{"label": _("Vehicle No."), "fieldname": "vehicle_no", "fieldtype": "Data", "width": 100},
			{"label": _("Claim Dt (From)"), "fieldname": "claim_dt_from", "fieldtype": "Data", "width": 100},
			{"label": _("Claim Dt (To)"), "fieldname": "claim_dt_to", "fieldtype": "Data", "width": 100},
		]
	)
	if filters.get("show_remarks"):
...
def get_employee_name_map():
	_map={}
	for i in frappe.get_all("Employee", fields={"name", "employee_name"}):
		_map[i["name"]] = i["employee_name"]
	return _map